...
public class EditSensorNamesListAdapter extends ArrayAdapter<Sensor>{
    ArrayList<Sensor> sensors;
    Context mContext;

    public EditSensorNamesListAdapter(@NonNull Context context, ArrayList<Sensor> sensors) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = LayoutInflater.from(getContext()).inflate(R.layout.edit_sensor_names_list_element, parent, false);
        }
